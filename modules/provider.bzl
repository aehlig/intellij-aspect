...
_IntelliJTopLevelTargetsInfo = _intellij_module_provider()  # Ensure all top-level targets are present
...
intellij_provider = struct(
    ...
    TopLevelTargetInfo = _IntelliJTopLevelTargetsInfo,
    ...
    ALL = _MODULE_PROVIDERS.values() + _TOOLCHAIN_PROVIDERS + [_IntelliJTopLevelTargetsInfo],
